...
public class TestInsert6 {
  ...
  RBT<Integer, String> buildTree() {
    ...
    RBTNode<Integer, String> T30 =
      new RBTNode<Integer, String>(THIRTY, sTHIRTY, Colour.RED);
  ...
  // Insertion of a node with key 28 triggers insert case 1(b),
  // which is then followd by insert case 6.
  // .
  ...
  public void ShapeAfterInsertion() {
    ...
    String sTWENTYEIGHT = new String("twenty-eight");
    T.insert(TWENTYEIGHT, sTWENTYEIGHT);
  ...
  public void CheckContents6() {
    ...
    assertTrue(sTWENTYEIGHT.equals(T.get(TWENTYEIGHT)));
