...
public class TestInsert2 {
  ...
  // Insertion of a node with key 3 triggers insert case 1(a),
  // which is then followd by insert case 2.
  // .
  ...
  public void ShapeAfterInsertion() {
    ...
    String sTHREE = new String("three");
    T.insert(THREE, sTHREE);
  ...
  public void CheckContents1() {
    ...
    assertTrue(sTHREE.equals(T.get(THREE)));
